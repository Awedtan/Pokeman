Public Class frmBattleSelect
	...
	Dim enemypokemon1(14) As String
	Dim enemypokemon2(14) As String
	Dim enemypokemon3(14) As String
	Dim enemypokemon4(14) As String
	Dim enemypokemon5(14) As String
	Dim enemypokemon6(14) As String
	...
	Private Sub btnRoute1_Click(sender As Object, e As EventArgs) Handles btnRoute1.Click
		...
		Select Case num
			Case 1
				enemyenemypokemon1 = frmMainMenu.Rattata
			Case 2
	...
	Private Sub btnTrainer8_Click(sender As Object, e As EventArgs) Handles btnTrainer8.Click
		...
		enemypokemon1 = frmMainMenu.Tauros
		enemyenemypokemon2 = frmMainMenu.Eevee
