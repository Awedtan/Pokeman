Public Class frmMainMenu
    ...
    Public Shared Venusaur() As String = {"Venusaur", 80, 82, 83, 80, 100, 0, 0, 7, 12}
    ...
    Public Shared Venonat() As String = {"Venonat", 60, 55, 50, 45, 40, 0, 0, 1, 12}
    Public Shared Venomoth() As String = {"Venomoth", 70, 65, 60, 90, 90, 0, 0, 1, 12}
    Public Shared Diglett() As String = {"Diglett", 10, 55, 25, 90, 45, 0, 0, 9, 0}
    Public Shared Dugtrio() As String = {"Dugtrio", 35, 80, 50, 120, 70, 0, 0, 9, 0}
    Public Shared Meowth() As String = {"Meowth", 40, 45, 35, 90, 40, 0, 0, 11, 0}
    Public Shared Persian() As String = {"Persian", 65, 70, 60, 115, 65, 0, 0, 11, 0}
    Public Shared Psyduck() As String = {"Psyduck", 50, 52, 48, 55, 50, 0, 0, 15, 0}
    Public Shared Golduck() As String = {"Golduck", 80, 82, 78, 85, 80, 0, 0, 15, 0}
    ...
    Public Shared Growlithe() As String = {"Growlithe", 55, 70, 45, 60, 50, 0, 0, 5, 0}
    Public Shared Arcanine() As String = {"Arcanine", 90, 110, 80, 95, 80, 0, 0, 5, 0}
    Public Shared Poliwag() As String = {"Poliwag", 40, 50, 40, 90, 40, 0, 0, 15, 0}
    Public Shared Poliwhirl() As String = {"Poliwhirl", 65, 65, 65, 90, 50, 0, 0, 15, 0}
    Public Shared Poliwrath() As String = {"Poliwrath", 90, 85, 95, 70, 70, 0, 0, 15, 4}
    Public Shared Abra() As String = {"Abra", 25, 20, 15, 90, 105, 0, 0, 13, 0}
    Public Shared Kadabra() As String = {"Kadabra", 40, 35, 30, 105, 120, 0, 0, 13, 0}
    Public Shared Alakazam() As String = {"Alakazam", 55, 50, 45, 120, 135, 0, 0, 13, 0}
    ...
    Public Shared Graveler() As String = {"Graveler", 55, 95, 115, 35, 45, 0, 0, 14, 9}
    Public Shared Golem() As String = {"Golem", 80, 110, 130, 45, 55, 0, 0, 14, 9}
    Public Shared Ponyta() As String = {"Ponyta", 50, 85, 55, 90, 65, 0, 0, 5, 0}
    Public Shared Rapidash() As String = {"Rapidash", 65, 100, 70, 105, 80, 0, 0, 5, 0}
    ...
    Public Shared Magnemite() As String = {"Magnemite", 25, 35, 70, 45, 95, 0, 0, 10, 0}
    Public Shared Magneton() As String = {"Magneton", 50, 60, 95, 70, 120, 0, 0, 10, 0}
    Public Shared Farfetchd() As String = {"Farfetch'd", 52, 65, 55, 60, 58, 0, 0, 11, 6}
    Public Shared Doduo() As String = {"Doduo", 35, 85, 45, 75, 35, 0, 0, 11, 6}
    Public Shared Dodrio() As String = {"Dodrio", 60, 110, 70, 100, 60, 0, 0, 11, 6}
    Public Shared Seel() As String = {"Seel", 65, 45, 55, 45, 70, 0, 0, 15, 0}
    Public Shared Dewgong() As String = {"Dewgong", 90, 70, 80, 70, 95, 0, 0, 15, 3}
    Public Shared Grimer() As String = {"Grimer", 80, 80, 50, 25, 40, 0, 0, 12, 0}
    Public Shared Muk() As String = {"Muk", 105, 105, 75, 50, 65, 0, 0, 12, 0}
    Public Shared Shellder() As String = {"Shellder", 30, 65, 100, 40, 45, 0, 0, 15, 0}
    Public Shared Cloyster() As String = {"Cloyster", 50, 95, 180, 70, 85, 0, 0, 15, 12}
    Public Shared Gastly() As String = {"Gastly", 30, 35, 30, 80, 100, 0, 0, 8, 12}
    Public Shared Haunter() As String = {"Haunter", 45, 50, 45, 95, 115, 0, 0, 8, 12}
    Public Shared Gengar() As String = {"Gengar", 60, 65, 60, 110, 130, 0, 0, 8, 12}
    Public Shared Onix() As String = {"Onix", 35, 45, 160, 70, 30, 0, 0, 14, 9}
    Public Shared Drowzee() As String = {"Drowzee", 60, 48, 45, 42, 90, 0, 0, 13, 0}
    Public Shared Hypno() As String = {"Hypno", 85, 73, 70, 67, 115, 0, 0, 13, 0}
    Public Shared Krabby() As String = {"Krabby", 30, 105, 90, 50, 25, 0, 0, 15, 0}
    Public Shared Kingler() As String = {"Kingler", 55, 130, 115, 75, 50, 0, 0, 15, 0}
    Public Shared Voltorb() As String = {"Voltorb", 40, 30, 50, 100, 55, 0, 0, 10, 0}
    Public Shared Electrode() As String = {"Electrode", 60, 50, 70, 140, 80, 0, 0, 10, 0}
    Public Shared Exeggcute() As String = {"Exeggcute", 60, 40, 80, 40, 60, 0, 0, 7, 13}
    Public Shared Exeggutor() As String = {"Exeggutor", 95, 95, 85, 55, 125, 0, 0, 7, 13}
    Public Shared Cubone() As String = {"Cubone", 50, 50, 95, 35, 40, 0, 0, 9, 0}
    Public Shared Marowak() As String = {"Marowak", 60, 80, 110, 45, 50, 0, 0, 9, 0}
    ...
    Public Shared Koffing() As String = {"Koffing", 40, 65, 95, 35, 60, 0, 0, 12, 0}
    ...
    Public Shared Kangaskhan() As String = {"Kangaskhan", 105, 95, 80, 90, 40, 0, 0, 11, 0}
    ...
    Public Shared Goldeen() As String = {"Goldeen", 45, 67, 60, 63, 50, 0, 0, 15, 0}
    Public Shared Seaking() As String = {"Seaking", 80, 92, 65, 68, 80, 0, 0, 15, 0}
    Public Shared Staryu() As String = {"Staryu", 30, 45, 55, 85, 70, 0, 0, 15, 0}
    ...
    Public Shared Electabuzz() As String = {"Electabuzz", 65, 83, 57, 105, 85, 0, 0, 10, 0}
    Public Shared Magmar() As String = {"Magmar", 65, 95, 57, 93, 85, 0, 0, 5, 0}
    Public Shared Pinsir() As String = {"Pinsir", 65, 125, 100, 85, 55, 0, 0, 1, 0}
    Public Shared Tauros() As String = {"Tauros", 75, 100, 95, 110, 70, 0, 0, 11, 0}
    Public Shared Magikarp() As String = {"Magikarp", 20, 10, 55, 80, 20, 0, 0, 15, 0}
    ...
    Public Shared Snorlax() As String = {"Snorlax", 160, 110, 65, 30, 65, 0, 0, 11, 0}
    Public Shared Articuno() As String = {"Articuno", 90, 85, 100, 85, 125, 0, 0, 3, 6}
    Public Shared Zapdos() As String = {"Zapdos", 90, 90, 85, 100, 125, 0, 0, 10, 6}
    Public Shared Moltres() As String = {"Moltres", 90, 100, 90, 90, 125, 0, 0, 5, 6}
    Public Shared Dratini() As String = {"Dratini", 41, 64, 45, 50, 50, 0, 0, 2, 0}
    Public Shared Dragonair() As String = {"Dragonair", 61, 84, 65, 70, 70, 0, 0, 2, 0}
    Public Shared Dragonite() As String = {"Dragonite", 91, 134, 95, 80, 100, 0, 0, 2, 6}
    ...
    Public Shared Ryu() As String = {"Ryu", 100, 100, 100, 100, 100, 0, 0, 4, 11}
    Public Shared Ken() As String = {"Ken", 100, 100, 100, 100, 100, 0, 0, 4, 11}
    Public Shared Blanka() As String = {"Blanka", 90, 120, 90, 120, 100, 0, 0, 4, 10}
    Public Shared MBison() As String = {"M.Bison", 105, 105, 105, 85, 130, 0, 0, 4, 12}
    Public Shared Akuma() As String = {"Akuma", 80, 150, 80, 110, 120, 0, 0, 4, 12}
    Public Shared Balrog() As String = {"Balrog", 125, 125, 120, 75, 60, 0, 0, 4, 4}
