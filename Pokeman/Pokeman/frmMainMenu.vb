Public Class MainMenu
	...
	Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim Ryu() As String = {"Ryu", 100, 100, 100, 0, 0, 4, 11}
        Dim Ken() As String = {"Ken", 100, 100, 100, 0, 0, 4, 11}
        Dim Blanka() As String = {"Blanka", 90, 120, 90, 0, 0, 4, 10}
        Dim MBison() As String = {"M.Bison", 105, 105, 105, 0, 0, 4, 12}
        Dim Akuma() As String = {"Akuma", 80, 150, 80, 0, 0, 4, 12}
        Dim Balrog() As String = {"Balrog", 110, 110, 80, 0, 0, 4, 4}
