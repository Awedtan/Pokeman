Public Class frmMainMenu
    ...
    Public Shared Clefairy() As String = {"Clefairy", 70, 45, 48, 35, 60, 0, 0, 11, 0, "Double Slap", "Metronone", "Light Screen", "Defense Curl"}
    Public Shared Clefable() As String = {"Clefable", 95, 70, 73, 60, 85, 0, 0, 11, 0, "Double Slap", "Metronone", "Light Screen", "Defense Curl"}
    ...
    Public Shared Jigglypuff() As String = {"Jigglypuff", 115, 45, 20, 20, 25, 0, 0, 11, 0, "Sing", "Rest", "Double-Edge", "Disable"}
    Public Shared Wigglytuff() As String = {"Wigglytuff", 140, 70, 45, 45, 50, 0, 0, 11, 0, "Sing", "Rest", "Double-Edge", "Disable"}
    ...
    Public Shared Psyduck() As String = {"Psyduck", 50, 52, 48, 55, 50, 0, 0, 15, 0, "Confusion", "Disable", "Hydro Pump", "Skull Bash"}
    Public Shared Golduck() As String = {"Golduck", 80, 82, 78, 85, 80, 0, 0, 15, 0, "Confusion", "Hydro Pump", "Mega Kick", "Disable"}
    ...
    Public Shared Alakazam() As String = {"Alakazam", 55, 50, 45, 120, 135, 0, 0, 13, 0, "Psychic", "Reflect", "Recover", "Metronone"}
    ...
    Public Shared Doduo() As String = {"Doduo", 35, 85, 45, 75, 35, 0, 0, 11, 6, "Drill Peck", "Fury Attack", "Agility", "Rage"}
    Public Shared Dodrio() As String = {"Dodrio", 60, 110, 70, 100, 60, 0, 0, 11, 6, "Drill Peck", "Tri Attack", "Sky Attack", "Fury Attack"}
    ...
    Public Shared Vaporeon() As String = {"Vaporeon", 130, 65, 60, 65, 110, 0, 0, 15, 0, "Ice Beam", "Double-Edge", "Surf", "Bide"}
    ...
    Public Shared Articuno() As String = {"Articuno", 90, 85, 100, 85, 125, 0, 0, 3, 6, "Blizzard", "Sky Attack", "Hyper Beam", "Mist"}
    Public Shared Zapdos() As String = {"Zapdos", 90, 90, 85, 100, 125, 0, 0, 10, 6, "Thunder", "Sky Attack", "Thunder Wave", "Hyper Beam"}
    Public Shared Moltres() As String = {"Moltres", 90, 100, 90, 90, 125, 0, 0, 5, 6, "Fire Spin", "Sky Attack", "Fire Blast", "Hyper Beam"}
