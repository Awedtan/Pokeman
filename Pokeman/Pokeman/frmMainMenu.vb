Public Class MainMenu
	...
	'Pokeman name, health, attack, defense, obtained, selected, type1, type2
	...
	Dim Pokemon1(7) As String
	Dim Pokemon2(7) As String
	Dim Pokemon3(7) As String
	Dim Pokemon4(7) As String
	Dim Pokemon5(7) As String
	Dim Pokemon6(7) As String
